...
const StudentCalendar = () => {
  ...
  const { getLecturesByClass, getAssignmentsForStudent } = useEducation();
  ...
  const allAssignments = classes.flatMap((cls) =>
    getAssignmentsForStudent(cls.id).map((a) => ({
      ...a,
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            View your classes and assignment deadlines
          </p>
        </div>
                ...
                {days.map((day) => {
                  ...
                  return (
                    <div
                      key={day.toISOString()}
                      className={cn(
                        "aspect-square p-1 border rounded-lg hover:bg-muted/50 cursor-pointer",
                ...
                .map((event) => (
                  <div
                    ...
                    onClick={() =>
                      ...
                      event.lecture &&
                      navigate(
                        `/education/student/classes/${event.lecture.classId}/lecture/${event.lecture.id}/meeting`
                      )
                    }
                  >
